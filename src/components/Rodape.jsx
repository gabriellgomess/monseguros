    ...
    return (
        <footer className='container-rodape'>
            <Box>
                ...
                <p className='text-white' style={{marginTop: '20px'}}>Copyright &copy; {new Date().getFullYear()}</p>
                <p className='text-white' style={{marginTop: '20px'}}>Mon Seguros</p>
                <p className='text-white' style={{marginTop: '20px'}}>CNPJ: 54.561.419/0001-41</p>
                ...
                <p className='text-white'>atendimento@monseguros.com.br</p>
            </Box>
            <Box>
